    ...
    <div class="col-md-8">
        <div class="card shadow-sm border-0 rounded-4">
            <div class="card-header bg-white border-bottom-0 pt-4 pb-0 ps-4">
                <h3 class="fw-bold text-dark mb-0">Edit Topic: {{ $topic->title }}</h3>
            </div>
                ...
                <form action="{{ route('topics.update', $topic) }}" method="POST">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control @error('speaker_name') is-invalid @enderror" id="speaker_name" name="speaker_name" value="{{ old('speaker_name', $topic->speaker_name) }}" required>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control @error('location') is-invalid @enderror" id="location" name="location" value="{{ old('location', $topic->location) }}">
                            @error('location') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>
                        <div class="col-md-3">
                            <label for="seat_limit" class="form-label fw-medium">Seat Limit</label>
                            <input type="number" class="form-control @error('seat_limit') is-invalid @enderror" id="seat_limit" name="seat_limit" value="{{ old('seat_limit', $topic->seat_limit) }}" min="1" required>
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="datetime-local" class="form-control @error('event_date') is-invalid @enderror" id="event_date" name="event_date" value="{{ old('event_date', optional($topic->event_date)->format('Y-m-d\TH:i')) }}" required>
                    ...
                    <div class="d-flex justify-content-end mt-4">
                        ...
                        <button type="submit" class="btn btn-primary rounded-pill px-4 shadow-sm">Update Topic</button>
                    </div>
                </form>
            </div>
        </div>
